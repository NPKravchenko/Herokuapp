...
public class GetBookingsTest extends BaseTest {
    ...
    @Test(description = "Получение всех ID бронирований без фильтров")
    @Story("Получение списка всех бронирований")
    @Severity(SeverityLevel.NORMAL)
    @Description("Проверяется, что запрос к /booking возвращает статус 200 и непустой список ID бронирований")
